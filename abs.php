...
<!DOCTYPE html>
<html>
<?php $title="lifeLinker | Available Organ Samples"; ?>
...
<body>
    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">Select Organ:</label>
               ...
               <option value="Kidney">Kidney</option>
                ...
                <option value="Pancreas">Pancrease</option>
        ...
        <table class="table table-responsive table-striped rounded mb-5">
            <tr><th colspan="7" class="title">Available Organs</th></tr>
            <tr>
                <th>#</th>
                <th>Hospital Name</th>
                <th>Hospital City</th>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><a href="javascript:void(0);" class="btn btn-info hospital">Request Organ</a></td>
